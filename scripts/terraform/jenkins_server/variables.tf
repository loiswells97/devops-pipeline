...
variable "name1" { default = "Debian Coursework Jenkins VM" }
...
variable "server1_script" { default = "./debian_jenkins_server.sh" }
variable "security_description" { default = "Terraform security group" }
variable "security_name" { default = "coursework_security_jenkins" }
