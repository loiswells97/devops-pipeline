...
variable "name1" { default = "Debian Coursework VM 2" }
...
variable "server1_script" { default = "./debian_coursework_server.sh" }
variable "security_description" { default = "Terraform security group" }
variable "security_name" { default = "coursework_security_2" }
